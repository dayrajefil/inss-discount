document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.zip-code-mask').forEach(applyCepMask);
  const zipCodeInput = document.querySelector('[id$=zip_code]');
  if (zipCodeInput) fetchAddressByCep(zipCodeInput);

  document.querySelectorAll('.salary-mask').forEach(applySalaryMask);
